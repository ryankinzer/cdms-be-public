...
values('Characteristics','Characteristics','Characteristics',1081,null,'{}',null);
...
update dbo.Characteristics set Inactive = 0
...
--update dbo.Fields set PossibleValues = null where Id = 2172;
--update dbo.Fields set DataSource = 'select [Id], CharacteristicName from dbo.Characteristics' where Id = 2172

insert into dbo.LookupTables([Name], Label, [Description], DatasetId)
values ('Characteristics', 'Characteristics', 'Characteristics Lookup Table', 1292)
...
(null, 'Inactive', 'Is the characteristic inactive?', null, null, 'int', null, null, 'Inactive', 'number', null, 39, 2)
