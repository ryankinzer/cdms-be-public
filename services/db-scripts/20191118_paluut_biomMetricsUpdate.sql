-- Update biomonitoring datasets to match fields with GeoOptix

-- remove the fields Colette added via the 
alter table BiomVisitMetrics_Detail drop column DensityOfOtherSpecies;
alter table BiomVisitMetrics_Detail drop column LargeWoodVolumeBankfull;
alter table BiomVisitMetrics_Detail drop column LWVBankfullFNT;
alter table BiomVisitMetrics_Detail drop column LWVBankfull_SW;
alter table BiomVisitMetrics_Detail drop column LWV_Wetted;
alter table BiomVisitMetrics_Detail drop column LWVWetted_FNT;
alter table BiomVisitMetrics_Detail drop column LWVWetted_FT;

delete from datasetfields where dbcolumnname in ('DensityOfOtherSpecies',      
'LargeWoodVolumeBankfull',          
'LWVBankfullFNT',
'LWVBankfull_SW',
'LWV_Wetted',
'LWVWetted_FNT',
'LWVWetted_FT') and datasetid = 1277;

delete from fields where dbcolumnname in ('DensityOfOtherSpecies',      
'LargeWoodVolumeBankfull',          
'LWVBankfullFNT',
'LWVBankfull_SW',
'LWV_Wetted',
'LWVWetted_FNT',
'LWVWetted_FT') and datastoreid = 29
...
update datasetfields set DbColumnName = #changedfields.fieldTo, Label = #changedfields.fieldTo 
from #changedfields
...
alter table BiomChannelUnitMetrics_Detail drop column ChUnitNum;
alter table BiomChannelUnitMetrics_Detail add ChannelUnitID int;
go
